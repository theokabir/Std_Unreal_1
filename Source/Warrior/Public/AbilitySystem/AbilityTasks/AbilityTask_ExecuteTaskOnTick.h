...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Warrior|AbilityTasks", meta = (HidePin = "OwningGameplayAbility", DefaultToSelf = "OwningGameplayAbility", BlueprintInternalUseOnly = "true"))
	...
	UPROPERTY(BlueprintAssignable, Category = "Warrior|AbilityTasks")
